...
export default {
  ...
  methods: {
    ...
    q0(tapes1, tapes2, before, active){           // STATE
        ...
        if(tapes1[active].symbol == '0' && tapes2[active].symbol == 'y' ){  //IF INPUTAN
            this.changeTapes(active,'0','y')  // PERUBAHAN INPUTAN
            setTimeout(() => this.q0(tapes1, tapes2, active, active +1), this.delay);  // +1 ke kanan -1 ke kiri
        }
    ...
    q3(tapes1, tapes2, before, active){          
        ...
        if(tapes1[active].symbol == '0' && tapes2[active].symbol == 'b' ){
            ...
            this.changeTapes(active,'b','b')
            setTimeout(() => this.q0(tapes1, tapes2, active, active +1), this.delay);
        }
    },
