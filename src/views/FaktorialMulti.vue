...
<script>
export default {
  name: 'Faktorial Multitrack', // NAMA DIUBAH
  props: {
  ...
  methods: {
    ...
    start(){ // GAUSAH DIGANTI
        if(this.a < 0){
            alert("Tidak terdefinisikan")
        }
        else{
            this.onStart = true
            alert("Mulai")
            this.q1(this.tapes1, this.tapes2, this.before, this.active)
        }
    },

    q1(tapes1, tapes2, before, active){           // STATE
        this.changeActive(tapes1, tapes2, before, active)   // GAUSAH DIUBAH
        if(tapes1[active].symbol == '0' && tapes2[active].symbol == 'b' ){  //IF INPUTAN
            this.changeTapes(active,'0','b')  // PERUBAHAN INPUTAN
    ...
    q3(tapes1, tapes2, before, active){          
        this.changeActive(tapes1, tapes2, before, active)
        if(tapes1[active].symbol == '0' && tapes2[active].symbol == 'y' ){
            this.changeTapes(active,'0','y')
            setTimeout(() => this.q3(tapes1, tapes2, active, active+1), this.delay);
        }
    ...
    q5(tapes1, tapes2, before, active){          
        ...
        else if(tapes1[active].symbol == '0' && tapes2[active].symbol == 'y' ){
            this.changeTapes(active,'0','y')
            setTimeout(() => this.q5(tapes1, tapes2, active, active -1), this.delay);
        }
        else if(tapes1[active].symbol == 'x' && tapes2[active].symbol == 'b' ){
    ...
    q13(tapes1, tapes2, before, active){          
        ...
        if(tapes1[active].symbol == '0' && tapes2[active].symbol == 'x' ){
            ...
            this.changeTapes(active,'b','b')
            setTimeout(() => this.q30(tapes1, tapes2, active, active -1), this.delay);
        }
    },
    ...
    q27(tapes1, tapes2, before, active){          
        ...
        if(tapes1[active].symbol == 'x' && tapes2[active].symbol == 'b' ){
            ...
            this.changeTapes(active,'b','b')
            setTimeout(() => this.q28(tapes1, tapes2, active, active -1), this.delay);
        }
    },

    q28(tapes1, tapes2, before, active){          
        this.changeActive(tapes1, tapes2, before, active)
        
        if(tapes1[active].symbol == 'x' && tapes2[active].symbol == 'b' ){
            this.changeTapes(active,'b','b')
            setTimeout(() => this.q29(tapes1, tapes2, active, active -1), this.delay);
        }
    },

    q29(tapes1, tapes2, before, active){          
        this.changeActive(tapes1, tapes2, before, active)
        if(tapes1[active].symbol == 'x' && tapes2[active].symbol == 'b' ){
            this.changeTapes(active,'x','b')
            setTimeout(() => this.q29(tapes1, tapes2, active, active -1), this.delay);
    ...
    q30(tapes1, tapes2, before, active){          
        this.changeActive(tapes1, tapes2, before, active)
        if(tapes1[active].symbol == 'x' && tapes2[active].symbol == 'b' ){
            this.changeTapes(active,'x','b')
            setTimeout(() => this.q30(tapes1, tapes2, active, active -1), this.delay);
            ...
            this.changeTapes(active,'0','b')
            setTimeout(() => this.q31(tapes1, tapes2, active, active +1), this.delay);
        }
    },

    q31(tapes1, tapes2, before, active){          
        this.changeActive(tapes1, tapes2, before, active)
        if(tapes1[active].symbol == 'x' && tapes2[active].symbol == 'b' ){
            this.changeTapes(active,'x','b')
            setTimeout(() => this.q31(tapes1, tapes2, active, active +1), this.delay);
