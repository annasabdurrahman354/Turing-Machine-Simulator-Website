<template>
<div class="px-4 flex flex-col justify-center items-center h-full w-full">
    <div class="mb-8">
  ...
  methods: {
    ...
    q0(tapes, before, active){          //ganti nama state
        ...
        switch (tapes[active].symbol) { //gak usah edit
            case '1':                                                           //ganti apa aja case symbol di state saaat ini
                tapes[active].symbol = "y"                                      //symbol input diubah jadi apa
                setTimeout(() => this.q31(tapes, active, active+1), this.delay); //q1 ganti nama state, active+1 kalo ke kanan, -1 ke kiri
                break;                                  
            case 'x':                                                           
